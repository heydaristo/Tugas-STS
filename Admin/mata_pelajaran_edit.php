...
<meta name="keywords" content="SMKN 1 SAYUNG" />
...
$Kode=$_GET['kode'];
$query=mysqli_query("select * from mata_pelajaran where kode_mata_pelajaran='$Kode'");
$data=mysqli_fetch_array($query);

$tampil_guru="SELECT * FROM `guru` where nip = '$data[nip]'";
$hasil_guru=mysqli_query($tampil_guru);
