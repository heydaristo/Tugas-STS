...
$hasil_guru=mysqli_query($cari_guru);
...
$hasil_mapel=mysqli_query($mapel);
...
$hasil_murid=mysqli_query($tampil_murid);
...
while ($data_murid=mysqli_fetch_array($hasil_murid))
{
	...
	$hasil_nilai=mysqli_query($tampil_nilai);
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© 2023 SMK Negeri 1 Sayung - Developed by RPL Team</a></p>
	</div>
</div>
<!-- //footer -->
